...
function XML() {
  return (
    <div className="container_components">
      ...
      <p>En travaillant sur FormCollect, j’ai conçu l’interface utilisateur via le XML en exploitant au maximum les layouts. Par exemple, j’ai utilisé des ConstraintLayout pour rendre l'application responsive ce qui permet un bon rendu visuel pour l'utilisateur peut importe la taille de l'écran et le type d'appareil utilisés.</p>
      ...
      <p>Pour rendre l’application utilisable aussi bien sur téléphone que sur tablette, j’ai créé des versions alternatives de certains layouts comme le layout-land et le sw600dp. Le tout géré automatiquement grâce au système de ressources XML Android.</p>
      <br></br>
