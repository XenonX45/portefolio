...
function Java() {
  return (
    <div className="container_components">
      ...
      <p>À un moment, les données du formulaire n’étaient pas enregistrées correctement. Après débogage, je me suis rendu compte que j’avais oublié d’exécuter une opération en background thread. J’ai alors utilisé AsyncTask (Executors ou LiveData) pour que le DAO n'exécute plus de requêtes sur le thread principal. Résultat plus de crash et une meilleure fluidité.</p>
      <p>Grâce à mes compétences en Java, j’ai réussi à développer l’ensemble des demandes des deux commanditaires ce qui leur a permis d’avoir une meilleure organisation au sein de leur entreprise.</p>
      <br></br>
