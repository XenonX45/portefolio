...
import nomprenomform from "../img/capture/formcollect/nomprenomform.png";
import Circuits_predefinis_GPS from "../img/capture/formcollect/Circuits_predefinis_GPS.png";
import Appareil_photo_avant_apres_renommage from "../img/capture/formcollect/Appareil_photo_avant_apres_renommage.png";
import Verification_modification_formulaire from "../img/capture/formcollect/Verification_modification_formulaire.png";
import Export_Drive_Excel from "../img/capture/formcollect/Export_Drive_Excel.png";
...
function FormCollect() {
  return (
    <div className="container_components">
      ...
      <p>L’association AFDAS souhaitait moderniser le fonctionnement de collection dans les points relais qu’elle devait gérer dans l’agglomération d’Agen. Elle souhaitait que nous développions une application Android qu’elle pourrait utiliser à la place du papier.</p>
      <br></br>
      ...
      <p>La première étape consistait à faire une page d’accueil qui permettrait aux employés de l’AFDAS de pouvoir rentrer leur nom et prénom pour qu’ils puissent être enregistrés en tant que tel. Il fallait aussi mettre en place des circuits prédéfinis par la ville d’Agen selon les horaires de passage des salariés. On a dû développer un GPS qui permettait, selon le circuit sélectionné, de faire l’ensemble de l’itinéraire le plus optimisé.</p>
      <img className="formcollect" src={nomprenomform}></img>
      <img className="formcollect" src={Circuits_predefinis_GPS}></img>
      ...
      <img className="formcollect" src={Appareil_photo_avant_apres_renommage}></img>
      ...
      <img className="formcollect" src={Verification_modification_formulaire}></img>
      ...
      <img className="formcollect" src={Export_Drive_Excel}></img>
      ...
      <p>Actuellement, l’outil remplit l’ensemble des fonctionnalités qu’il devait remplir en optimisant le processus de collecte de l’association AFDAS. Grâce au développement de l’ensemble des fonctionnalités de l'application les salariés de l’association AFDAS ont un travail au quotidien moins important en effet l’automatisation de certaine tâche comme le transfert des photos ou l’ajout de chaque ligne dans un Excel à la suite d’une collection se fait automatiquement ce qui est un réel soulagement pour l’association. L’application leur permet aussi d’éviter des erreurs de saisies qui pourraient fausser leur statistique.</p>
      <p>Auparavant, les nouveaux salariés étaient contraints de devoir apprendre les circuits puis de saisir toutes les données des collectes sur un Excel avec des consignes et des potentielles erreurs au départ. Maintenant, ils peuvent être opérationnels directement après la signature de leur contrat puisse que l’ensemble des itinéraires ainsi que les informations demandées soient affichées sur l’application avec l’automatisation de leur saisit sur l’application qui est directement envoyer dans un dossier prédéfini avec les photos envoyer sur un Google Drive. Le suivi des passages des salariés est donc plus simple à traiter.</p>
      <br></br>
      ...
      <p>Ce projet a été une véritable révélation pour moi. J'ai réalisé que la vision que nous avons en tant que développeurs d'une fonctionnalité peut différer de celle de l'utilisateur final. Il est donc crucial de guider et d'accompagner les utilisateurs tout au long de leur expérience avec l'outil et de s'adapter à eux.</p>
